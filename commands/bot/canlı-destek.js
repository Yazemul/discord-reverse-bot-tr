...
module.exports = class SupportCommand extends commando.Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Reverse Bot Destek Ekibi ile görüşmeye bağlanırsınız.',
      details: oneLine `
               Reverse Bot ile ilgili yardıma ihtiyacınız var mı?
  ...
  async run(message) {
    ...
    message.reply(`Reverse Bot Desteği ile iletişim kurduğunuz için teşekkür ederiz! Herhangi bir destek yetkilisi varsa, yakında sizinle iletişim kuracaktır.`)
    let chan = message.channel
    let supportChan = '331846231514939392'
    const embed = new RichEmbed()
      ...
      .setFooter('Reverse Bot canlı-destek sistemi')
      .setTimestamp()
