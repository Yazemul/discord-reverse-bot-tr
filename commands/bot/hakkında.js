...
module.exports = class EmbedCommand extends Command {
    ...
    async run(message) {
		...
		.setColor("RANDOM")
		.addField(`❯ Botun İsmi/Adı:`, `Reverse Bot`)
		.addField(`❯ Botun Sahibi/Yapımcısı:`, `<@331846231514939392>`)
		...
		**• Node:** ${process.version}
		`)
		.addField(`❯ Botun Linkleri:`, `**[Botu sunucuna eklemek için tıkla!](https://discordapp.com/api/oauth2/authorize?client_id=537303372794167306&permissions=8&scope=bot) \n[Botun destek sunucusuna gelmek için tıkla!](https://discord.gg/rc5kfTU) \n[Bota oy vermek için tıkla!](https://discordbots.org/bot/457547769159352341) \n[Botun sitesine bakmak için tıkla!](http://better-bot.rf.gd/)**`)
        .setFooter('©' + (new Date()).getFullYear() + ' Reverse Bot')
